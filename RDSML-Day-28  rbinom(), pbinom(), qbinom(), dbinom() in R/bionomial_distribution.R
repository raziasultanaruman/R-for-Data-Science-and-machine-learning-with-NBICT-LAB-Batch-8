# Explaining rbinom()
# rbinom(n, size, prob) generate random numbers from a binomal distribution
# Here:
...
# The result means there's about a 62.30% chance of getting 5 or fewer successes
...
# size = 5 ---> number of independant trials
